...
const cookieExpirationInDays = 0.0034722; // ~5 minutes

export default function useGoogleLogin(booking?: BookingDetailsType) {
  ...
  // since this is a hook, this return is actually returning the login function
  return login;
}
